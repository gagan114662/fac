#!/usr/bin/env python3
"""Deterministic PR preflight gate for fac harness engineering."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="fac risk policy gate")
    ...
    parser.add_argument("--contract", default="harness/contract.json", help="Path to machine-readable harness contract")
...
def main() -> int:
    ...
    primary_provider = str(review_policy.get("provider", "coderabbit"))
    check_name = str(review_policy.get("checkRunName", "coderabbit-review"))
    timeout_minutes = int(review_policy.get("timeoutMinutes", 15))
